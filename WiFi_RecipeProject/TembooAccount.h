...
#define TEMBOO_ACCOUNT "saiyamanoor"  // Your Temboo account name 
#define TEMBOO_APP_KEY_NAME "myFirstApp"  // Your Temboo app name
#define TEMBOO_APP_KEY "dda526bd-822b-4f0a-9"  // Your Temboo app key

#define WIFI_SSID "Hogwarts"
#define WPA_PASSWORD "Expectopatronum1987"
